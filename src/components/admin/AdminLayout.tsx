...
const getNotifications = () => [
  ...
  },
  {
    ...
    type: "shipped",
    title: "Order Shipped",
    message: "Order #D4E5F6 has been shipped",
    time: "1 hour ago",
    read: false,
  },
  {
    ...
    message: "3 products are running low",
    time: "2 hours ago",
    read: true,
  },
  {
    ...
    message: "Payment confirmed for #G7H8I9",
    time: "3 hours ago",
    read: true,
  },
];
...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-slate-800 text-white flex flex-col transform transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`}
      >
        ...
        <div className="p-4 border-t border-slate-700">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link
              to="/"
              className="flex items-center justify-center gap-1 py-2 bg-slate-700 rounded-lg text-sm hover:bg-slate-600 transition-colors"
            >
              <Home className="w-4 h-4" /> Store
            </Link>
            <button
              onClick={handleLogout}
              className="flex items-center justify-center gap-1 py-2 bg-red-500/20 text-red-400 rounded-lg text-sm hover:bg-red-500/30 transition-colors"
            >
          ...
          <div className="flex items-center justify-between px-4 lg:px-6 py-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                ...
                {showNotifications && (
                  <div
                    className="absolute right-0 top-full mt-2 w-80 bg-white rounded-xl shadow-xl border border-gray-100 z-50"
                  ...
                  >
                    ...
                    <div className="max-h-80 overflow-y-auto">
                      {notifications.map((notif) => (
                        <div
                          key={notif.id}
                          className={`p-4 border-b border-gray-50 hover:bg-gray-50 flex gap-3 ${!notif.read ? "bg-orange-50/50" : ""}`}
                        >
              ...
              <div className="relative">
                ...
                {showSettings && (
                  <div
                    className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 z-50"
                    onClick={(e) => e.stopPropagation()}
                  >
                    ...
                    <div className="p-4 border-t border-gray-100">
                      <Link
                        ...
                        className="block w-full py-2 text-center bg-gray-100 rounded-lg text-sm hover:bg-gray-200"
                      >
